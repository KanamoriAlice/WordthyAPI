...
public class TemporaryStrings {
	
	public static final String CARD_ID_NOT_BLANK = "Card id cannot be empty nor null";
	public static final String DECK_NOT_BLANK = "Deck name cannot be empty nor null";
	public static final String DECK_SETTINGS_NOT_BLANK = "Deck settings name cannot be empty nor null";
